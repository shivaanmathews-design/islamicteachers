      ...
      <div className="container" style={{ maxWidth:780, padding:'48px 20px' }}>
        <div style={{ background:'#fff', borderRadius:14, padding:40, border:'1.5px solid #e8e8e8' }}>
          {[
            ...
            ['11. Contact','For any privacy-related queries, contact us at admin@islamicteachers.co.za. For complaints, you may also contact the Information Regulator of South Africa at inforeg.org.za.'],
          ].map(([heading, body]) => (
