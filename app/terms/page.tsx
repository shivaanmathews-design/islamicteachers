      ...
      <div className="container" style={{ maxWidth:780, padding:'48px 20px' }}>
        <div style={{ background:'#fff', borderRadius:14, padding:40, border:'1.5px solid #e8e8e8' }}>
          {[
            ...
            ['9. Termination','We may suspend or terminate any account at any time for breach of these Terms. You may cancel your listing at any time by contacting islamicteachersadmin@gmail.com.'],
            ...
            ['11. Contact','islamicteachersadmin@gmail.com'],
          ].map(([heading, body]) => (
